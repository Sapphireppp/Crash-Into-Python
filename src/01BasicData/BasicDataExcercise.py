...
# if a year is devisible by 4, then it is a leap year;  true
# unless it is devisible by 100, then it is not;        False
# unless it is devisible by 400, then it is a leap year. true
# therefore
